...
body:before {
  ...
  content: "Error: File to import not found or unreadable: vars.\A        Load path: C:/Users/user/Desktop/product_page\A         on line 1 of ./node_modules/node-sass/test/fixtures/include-path/index.scss\A \A 1: @import 'vars';\A 2: @import 'colorBlue';\A 3: \A 4: body {\A 5:   background: $color;\A 6:   color: colorBlue();"; }
